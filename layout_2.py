...
class BlockDiagramLayout(object):
    ...
    def draw_layout(self):
        ...
        self.dot = pgv.AGraph(comment=main_block, directed=True, compound=True, rank='same',
                              ...
                              strict=False, overlap=False, rankdir='LR', ranksep='2')
        second_level_nodes = []
        ...
        print 'Second level nodes are: ', ', '.join(second_level_nodes)
        print 'The nodes can be positioned in a 3X3 matrix as per your choice .. '
        # position matrix
        for i in range(3):
            for j in range(3):
                print i+1, j+1
